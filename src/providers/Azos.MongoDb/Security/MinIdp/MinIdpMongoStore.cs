...
namespace Azos.Security.MinIdp
{
  ...
  /// </summary>
  public sealed class MinIdpMongoStore : DaemonWithInstrumentation<IApplicationComponent>, IMinIdpStoreImplementation
  {
    public MinIdpMongoStore(IApplicationComponent dir) : base(dir)
    {
    }
